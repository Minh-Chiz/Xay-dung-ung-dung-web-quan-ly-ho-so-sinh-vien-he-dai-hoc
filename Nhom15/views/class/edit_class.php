...
checkRole(['teacher'], __DIR__ . '/../class.php', "Bạn không có quyền chỉnh sửa lớp học.");
?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="container mt-3">
        ...
        <?php
            ...
            // SỬA LỖI 1: Include thẳng file functions và gọi hàm gốc
            require_once __DIR__ . '/../../functions/class_functions.php';
            $class = getClassById($id); // Thay vì gọi handleGetClassById
