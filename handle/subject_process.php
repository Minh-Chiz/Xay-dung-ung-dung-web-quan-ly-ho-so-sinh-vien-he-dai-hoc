...
switch ($action) {
    case 'create':
        checkRole(['teacher', 'admin'], '../views/subject.php', "Bạn không có quyền thêm học phần.");
        handleCreateSubject();
        break;
    case 'edit':
        checkRole(['teacher', 'admin'], '../views/subject.php', "Bạn không có quyền chỉnh sửa học phần.");
        handleEditSubject();
        break;
    case 'delete':
        checkRole(['teacher', 'admin'], '../views/subject.php', "Bạn không có quyền xóa học phần.");
        handleDeleteSubject();
        break;
    default:
