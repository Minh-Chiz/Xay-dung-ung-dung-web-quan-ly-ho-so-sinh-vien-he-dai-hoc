<?php
$pageTitle = "Chỉnh sửa Điểm số"; // Đặt tiêu đề
// Kiểm tra đăng nhập
require_once __DIR__ . '/../../functions/auth.php';
checkLogin(__DIR__ . '/../../index.php');
checkRole(['teacher', 'admin'], __DIR__ . '/../grade.php', "Bạn không có quyền chỉnh sửa điểm số.");
    ...
    <div class="col-md-6">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body p-4">
                <h3 class="mb-4">CHỈNH SỬA ĐIỂM SỐ</h3> <?php
                ...
                <form action="../../handle/grade_process.php" method="POST" id="editGradeForm">
            ...
            <div class="card-footer bg-light border-0 text-end p-3">
                ...
                <button type="submit" class="btn btn-primary" form="editGradeForm">
                    <i class="bi bi-save me-1"></i> Cập nhật điểm
                </button>
            </div>
